...
native_literature = types.InlineKeyboardButton(text='Родная литература', callback_data='native_literature')
...
native_literature_update = types.InlineKeyboardButton(text='Родная литература (r)', callback_data='native_literature_update')
...
native_literature_update_p = types.InlineKeyboardButton(text='Родная литература (rp)', callback_data='native_literature_update_p')
...
native_literature_url = types.InlineKeyboardButton(text='Родная литература (u)', callback_data='native_literature_url')
